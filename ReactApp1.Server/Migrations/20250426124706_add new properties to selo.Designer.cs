...
namespace ReactApp1.Server.Migrations
{
    ...
    [Migration("20250426124706_add new properties to selo")]
    partial class addnewpropertiestoselo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReactApp1.Server.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ReactApp1.Server.Models.Cities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ReactApp1.Server.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ReactApp1.Server.Models.Cities", b =>
                {
                    b.HasOne("ReactApp1.Server.Models.Countries", "Country")
                        .WithMany("Cities")
